...
/// Struct representando un vector
...
/// Inicializa los arrays @param U y @param V con valores prefijados. La
/// longitud de los vectores se determina con @param N
...
/// Realiza el producto cruz entre los arrays @param U y @param V. Almacena
/// el resultado en el array @param W
